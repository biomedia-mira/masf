...
To run on medical dataset, replace functions of _construct_alexnet_weights()_ and _forward_alexnex()_ to _construct_unet_weights()_ and _forward_unet()_ provided in the medical folder 
